...
@click.option(
    "--host",
    help="Hostname r8 should listen on.",
    show_default=True,
    default="127.0.0.1",
)
@click.option(
    "--port",
    help="Port r8 should listen on.",
    show_default=True,
    type=int,
    default=8000,
)
@click.option(
    "--database", type=click.Path(dir_okay=False), envvar="R8_DATABASE", default="r8.db"
)
...
@util.with_database()
@click.option(
    "--rows", help="Example rows per table", show_default=True, type=int, default=1
)
def tables(rows):
